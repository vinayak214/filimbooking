import { StyleSheet, Text, View, SafeAreaView, Pressable, Animated, Easing, FlatList } from 'react-native'
...
const HomeScreen = () => {
    ...
    const applyFilter = (filter:any)=> {
        ...
        switch (filter) {
            case "English":
              setSortedData(
                sortedData.filter((item:any) => item.original_language === selectedFilter)
              );
              break;
            case "Kannada":
              setSortedData(
    ...
    useLayoutEffect(() => {
        navigation.setOptions({
            headerLeft: () => <Text style={{ color: 'black' }}>Hello Vinayak s</Text>,
            headerStyle: {
            ...
            <View>
                <FlatList
                    ...
                    renderItem={({ item, index }) =>
                        <MovieCard value={data[index]} key={index}></MovieCard>
                    }>
                </FlatList>
                <Pressable
                ...
                <BottomModal
                    ...
                    onHardwareBackPress={(): any => setModalVisible(!isModalVisible)}
                        ...
                        <Pressable
                            ...
                            {languages.map((item, index) =>
                                selectedFilter === item.language ? (
                                    ...
                                    >
                                        <Text style={{ color: "black" }}>{item.language}</Text>
                                    </Pressable>
                                ) : (
                                    <Pressable
